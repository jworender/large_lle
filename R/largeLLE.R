  ...
  if (family == 'gaussian') {
    ...
    time <- system.time(
      if (alg.logistic == 'MM') {
        ...
        message("Calling --> cdfit_binomial_ssr_approx")
        ...
        if (screen == "Hybrid") {
          message("Calling --> cdfit_binomial_slores_ssr")
          ...
          message("Calling --> cdfit_binomial_ada_slores_ssr")
          ...
          message("Calling --> cdfit_binomial_ssr")
    ...
    time <- system.time(
      if (screen == 'SSR') {
        ...
        res <- .Call("cdfit_cox_sscox", X@address, yy, d, as.integer(d_idx-1),
                     ...
                     as.integer(verbose), PACKAGE = 'largeLLE')
      } else if (screen == 'scox') {
