#' Plots the cross-validation curve from a "cv.largelle" object
#' 
#' Plot the cross-validation curve from a \code{\link{cv.largelle}} object,
...
#' 
#' @param x A \code{"cv.largelle"} object.
...
#' @examples
#' 
#' ## See examples in "cv.largelle"
#' 
#' @export
#' 
plot.cv.largelle <- function(x, log.l = TRUE, type = c("cve", "rsq", "scale", 
                                                       "snr", "pred", "all"), 
