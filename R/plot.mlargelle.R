#' Plot coefficients from a "mlargelle" object
#' 
#' Produce a plot of the coefficient paths for a fitted multiple responses
#' \code{mlargelle} object.
#' 
#' 
#' @param x Fitted \code{"mlargelle"} model.
...
#' @author Jason Orender, Chuyi Wang
#' 
#' Maintainer: Jason Orender <joren001@@odu.edu>
#' @seealso \code{\link{largeLLE}},
...
#' @export
#' 
plot.mlargelle <- function(x, alpha = 1, log.l = TRUE, norm.beta = TRUE, ...) {
